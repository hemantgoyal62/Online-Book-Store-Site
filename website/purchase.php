<?php
    ...
    if(isset($_POST['bookname']))
    {
        ...
        $r=mysqli_query($conn,"insert into cart(customer_id,Quantity,book_name) values('$cust_id',1,'$bookn');");
        if($r==true)
        {
            header("location:purchase.php?purchase=successful");
        }
        else
        {
            header("location:purchase.php?purchase=failed");
        }
    }
?>
<!DOCTYPE html>
...
<body >
    ...
    <div class="container">
        ...
        <div class="right-div">
            ...
            <div class="form">
                <h3>Log-in/Sign-in first if you haven't yet.</h3>
                <form method="post" action="">
                    <label for="cid">Customer_id:</label>
                    <input type="text" name="cid" placeholder="Enter user customer_id">
                    <br>  
                    <label for="bookname">Book Name:</label>  
                    <select type="text" name="bookname" placeholder="Enter your book name" id="input"  onchange="this.form.submit()">
                    <option value="none" disabled selected>--Select One--</option>
                    <optgroup label="Book Sets"></optgroup>
                    <option value="Dan Brown"><a href="Book_set1.html">Dan Brown</a></option>
                    <option value="Lolita,Mein kampf,anne frank">Lolita, Mein Kampf, Anne Frank</option>
                    <option value="George Orwell">George Orwell</option>
                    <option value="Millenium">Millenium Series</option>
                    <option value="Agastha Christie">Agastha Christie</option>
                    <option value="Selection">The Selection Series</option>
                    <optgroup label="Young Adult"></optgroup>
                    <option value="Mightier than the sword">Mightier Than the sword</option>
                    <option value="Postscript">PostScript</option>
                    <option value="Gone Girl">Gone Girl</option>
                    <option value="An Abundane of Katherines">An Ambulance of Katherines</option>
                    <option value="shadow and bone">Shadow and Bone</option>
                    <option value="Have a little faith">Have A Little Faith</option>
                    <optgroup label="Recently Purchased"></optgroup>
                    <option value="The Kite Runner">The Kite Runner</option>
                    <option value="A thousand Splendid Suns">A Thousand Splendid Suns</option>
                    <option value="Like Smoke">Like Smoke</option>
                    <option value="Target 3 Billions">Target 3 Billions</option>
                    <option value="Ahimsa">Ahimsa</option>
                    <option value="The Essential Rumi">The Essential Rumi</option>
                    <optgroup label="What's Trending"></optgroup>
                    <option value="On the Come Up">On the Come Up</option>
                    <option value="The Wasted Vigil">The Wasted Vigil</option>
                    <option value="The hunger games">The Hunger Games</option>
                    <option value="multiple">The Girl on the Train</option>
                    <option value="All the bright places">All the Bright Places</option>
                    <option value="Vanara">Vanara</option>
                    <optgroup label="Reader's Choice"></optgroup>
                    <option value="The help">The help</option>
                    <option value="The Greatest Story">Leo Tolstoy</option>
                    <option value="The Reluctant Fundamentalist">Reluctant Fundamentalist</option>
                    <option value="Best Kept Secret">Best Kept Secret</option>
                    <option value="Only Time will tell">Only Time Will Tell</option>
                    <option value="A thousand Splendid Suns">A Thousand Splendid Suns</option>
                </select>
                </form>
            </div>
